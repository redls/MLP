...
train_df = pd.read_csv("/home/s1410447/mlpractical/train.csv")
test_df = pd.read_csv("/home/s1410447/mlpractical/test.csv")


def train_model_and_plot_stats(history, nameOfFile=" ", model=None):
    lossFileName = '/home/s1410447/mlpractical/results/' +  nameOfFile + ' loss.pdf';
    accuracyFileName = '/home/s1410447/mlpractical/results/' + nameOfFile + ' accuracy.pdf';
    val_accuracy_on_validation = '/home/s1410447/mlpractical/results/' + nameOfFile + ' accuracy on validation set';
    file_model_sumary = '/home/s1410447/mlpractical/results/' + nameOfFile + ' model sumary';
    val_accuracy_on_training = '/home/s1410447/mlpractical/results/' + nameOfFile + ' accuracy on training set'
    val_loss_on_validation = '/home/s1410447/mlpractical/results/' + nameOfFile + ' loss on validation set'
    val_loss_on_training = '/home/s1410447/mlpractical/results/' + nameOfFile + ' loss on training set'
    #  "Accuracy"
...
def get_lstm_feats(a=20000, b=10, c=300, bat=32, seed = 42, run = 1):
    ...
    MAX_LEN = c
    NUM_CLASSES = 3
    nameOfFile = 'SimpleRNN 1 layer early stopping classic Adam selu opt Run ' + str(run)
    ...
    model.add(SimpleRNN(N, activation='selu', use_bias=True, kernel_initializer='glorot_uniform',
    ...
    modelName = '/home/s1410447/mlpractical/results/[model] ' + nameOfFile
